...
public class Map extends GUIObject {
	...
	public Map(float x, float y, Toolbox toolbox) {
		super(new MapRenderer(toolbox), x, y);
	}
	...
	private static class MapRenderer implements ObjectRenderer2D{
		private Toolbox toolbox;
		
		private int xOffset = 0, yOffset = 0;
		private int width = 100, height = 100;
		private float mapZoom = 0.0125f;
		
		public MapRenderer(Toolbox toolbox){
