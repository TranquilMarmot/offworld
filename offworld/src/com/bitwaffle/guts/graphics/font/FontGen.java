...
/*******************************************************************************
 *
 * Most of the source in here comes from LibGDX's TrueType font extension.
 * As per the Apache 2.0 license, I must state all the changes I made.
 * 
 * I'm not using LibGDX's sprite batch tools, which are required by their font
 * classes. I modified this source to fit more into my engine.
 * 
 ******************************************************************************/
 ...
 * 
 * @author mzechner */
public class FontGen implements Disposable {
	...
	public FontGen (FileHandle font) {
