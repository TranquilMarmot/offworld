...
public class Node implements Comparable<Node> {
	...
	private Node parent;
	/** Row and column location of this node in grid */
	private int row, col;
	
	private float 
		/** Distance straight to goal */
		hScore, 
		/** Distance to start point through parent nodes */
		gScore,
		/** gScore + hScore (used for sorting) */
		fScore;
	
	/**
	 * @param vector Location of node in world
 	 * @param row Grid row of node
	 * @param col Column row of node
	 */
